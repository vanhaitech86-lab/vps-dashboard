...
for line in lines:
    if '<table class="data-table" id="customersTable"' in line:
        ...
        out.append('''                                      <tr>
                                          ...
                                          <th colspan="2" style="text-align: center; background: #eff6ff;">
                                              KẾ HOẠCH
                                              <select id="customers-month-filter" style="border: none; border-bottom: 1px dashed #0369a1; border-radius: 0; padding: 0; font-weight: bold; background: transparent; cursor: pointer; color: #0369a1; outline: none; margin-left: 5px;">
                                                  <option value="08/2026" selected>THÁNG 8</option>
                                              </select>
                                          </th>
