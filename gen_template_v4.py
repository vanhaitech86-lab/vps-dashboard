...
# 3. Khách hàng (V4 - Có Kế hoạch tháng)
ws_cust = wb.create_sheet('Khách hàng')
ws_cust.merge_cells('A1:O1')
...
headers1 = ['Tháng/Năm', 'Công ty', 'Mảng kinh doanh', 'Kế hoạch tháng', '', 'Đầu kỳ', '', 'Tăng trong kỳ', '', 'Giảm trong kỳ', '', 'Cuối kỳ', '']
...
ws_cust.merge_cells('D2:E2') # Ke hoach
ws_cust.merge_cells('F2:G2') # Dau ky
...
for comp in companies:
    ...
    for cat in categories:
        ...
        if cat == 'Phân phối (Đại lý)':
            ws_cust.cell(row=row, column=4, value='-') # Ke hoach May
            ws_cust.cell(row=row, column=6, value='-') # Dau ky May
...
artifact_path = r'C:\Users\Hp\.gemini\antigravity\brain\c2c07afe-a201-42e1-b52e-07538b848a35\Template_Nhap_Lieu_VPS_V4_Final.xlsx'
