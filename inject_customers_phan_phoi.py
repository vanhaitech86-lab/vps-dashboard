...
data = {
    ...
    'THH': {
        ...
        'dv_khac': {'dau': {'may': 0, 'kh': 0}, 'tang': {'may': 0, 'kh': 0}, 'giam': {'may': 0, 'kh': 0}, 'cuoi': {'may': 0, 'kh': 0}},
        'phan_phoi': {'dau': {'may': 0, 'kh': 358}, 'tang': {'may': 0, 'kh': 2}, 'giam': {'may': 0, 'kh': 0}, 'cuoi': {'may': 0, 'kh': 360}},
    },
    'Viet': {
    ...
    'XemSon': {
        ...
        'dv_khac': {'dau': {'may': 0, 'kh': 0}, 'tang': {'may': 0, 'kh': 0}, 'giam': {'may': 0, 'kh': 0}, 'cuoi': {'may': 0, 'kh': 0}},
        'phan_phoi': {'dau': {'may': 0, 'kh': 435}, 'tang': {'may': 0, 'kh': 29}, 'giam': {'may': 0, 'kh': 0}, 'cuoi': {'may': 0, 'kh': 464}},
    },
    'VPSM': {
        ...
        'dv_khac': {'dau': {'may': 0, 'kh': 0}, 'tang': {'may': 0, 'kh': 0}, 'giam': {'may': 0, 'kh': 0}, 'cuoi': {'may': 0, 'kh': 0}},
        'phan_phoi': {'dau': {'may': 0, 'kh': 47}, 'tang': {'may': 0, 'kh': 22}, 'giam': {'may': 0, 'kh': 1}, 'cuoi': {'may': 0, 'kh': 68}},
    }
}

new_matrix_js = "matrix: " + json.dumps(data, indent=4)
...
# Replace the existing matrix in data.js. We know the previous one was right after 	rend: {...},
# Actually, since I ran inject_customers2.py earlier, the file already has matrix: { ... } after 	rend.
# So I should replace matrix: \{.*?\}\s*(?=,\s*hr:) with 
ew_matrix_js

js = re.sub(r'matrix:\s*\{[\s\S]*?\}\s*,\s*(?=hr:)', new_matrix_js + ',\n    ', js)
