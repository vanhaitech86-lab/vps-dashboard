...
rows_data = [
    # I. MIỀN BẮC
    ("I", "MIỀN BẮC", 90000, 41454, 0.10, 6070, 5, 6865, 1095, -89, 197473, 0.21, 44982, 335, 49241, 7731, -234, "header"),
    ("1", "THH (Tân Hồng Hà)", 50000, 8804, 0.18, 1568, 5, 1341, 8, 245, 66583, 0.21, 10082, 335, 12453, 57, 2376, "company"),
    ("a", "Khối dịch vụ kỹ thuật", "", 2578, 0.335, 864, "", 798, 1, 67, 16146, 0.36, 5747, 54, 5516, 1, 286, "sub"),
    ...
    ("b", "Kinh doanh tổng hợp", "", 1139, 0.15, 174.6, "", 165, 10, 10, 12938, 0.08, 1034.7, 9, 1157, 47, -66, "sub"),
    ("c", "Kinh doanh bán buôn", "", 4792, 0.10, 473.1, 5, 311, 7, 178, 35000, 0.09, 2275.1, 271, 2438, 10, 119, "sub"),
    ("d", "Dự án", "", 295, 0.19, 56.1, "", 67, "", -10, 2500, 0.41, 1025, "", 3342, "", 2038, "sub"),
    
    # 2. Việt
    ("2", "Việt", 10000, 6848, 0.203, 1390, 0, 983, 7, 382, 40294, 0.21, 8562, "", 6903, 13, 1672, "company"),
    ...
    # 4. CTY VPS
    ("4", "CTY VPS", 10000, 14951, 0.00, "", "", 2327, 1033, -828, 16633, "", 2288, "", 14400, 7665, -4447, "company"),
    ...
    # 5. XESCO
    ("5", "XESCO (Xem Sơn)", 15000, 10326, 0.28, 2912, "", 2129, 51, 834, 69425, 0.27, 18667, "", 14626, 226, 4267, "company"),
    ...
    # TỔNG CỘNG
    ("★", "TỔNG CỘNG TOÀN TẬP ĐOÀN", 93000, 43128, 0.15, 6309, 5, 7085, 1161, 830, 208724, 0.23, 47249, 335, 50756, 8033, 4861, "total")
]
